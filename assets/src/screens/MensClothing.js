...
export default function MensClothing() {
  ...
  if (id == "1") {
    navigation.navigate("Mens1");
    setId();
  }
  if (id == "2") {
    navigation.navigate("Mens2");
    setId();
  }

  if (id == "3") {
    navigation.navigate("Mens3");
    setId();
  }
  if (id == "4") {
    navigation.navigate("Mens4");
    setId();
  }
    ...
    <View style={styles.container}>
      ...
      {isloading === false && (
        <View style={styles.categoryTitleBox}>
          <Text style={styles.categoryTitle}>Men's Clothing:</Text>
        </View>
      )}
      <FlatList
        data={newItems}
